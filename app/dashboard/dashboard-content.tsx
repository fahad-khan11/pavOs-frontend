...
export default function DashboardContent({ whopCompanyId }: DashboardContentProps) {
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-gray-800">
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">In your pipeline</p>
                  </div>
                ...
                <div className="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-gray-800">
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">Successfully closed</p>
                  </div>
                  <span className="text-lg font-bold text-green-600 dark:text-green-400">{stats?.wonLeads || 0}</span>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white">Lost Deals</p>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Opportunities lost</p>
                  </div>
                  <span className="text-lg font-bold text-red-600 dark:text-red-400">{stats?.lostLeads || 0}</span>
                </div>
              </div>
            </CardContent>
          </Card>
