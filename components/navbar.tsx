...
import { LayoutDashboard, Users, Kanban, BarChart3, User, Settings, MessageSquare } from "lucide-react"
        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/dashboard" className="flex items-center gap-2 group">
              ...
              <span className="font-bold text-lg text-white dark:text-white">PaveOS</span>
            </Link>
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-2 text-white dark:text-white hover:bg-white/10 dark:hover:bg-white/10">
